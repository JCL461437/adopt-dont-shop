...
RSpec.describe "the admin shelters index" do
  ...
  describe "displays a section for shelters with pending applications" do
    it "in this section I see the name of every shelter that has a pending application" do
      ...
      within "#shelters-pending-applicaiton" do
        expect(page).to have_content("#{pet_application2}")
        expect(page).to have_content("#{pet_application3}")
        expect(page).to_not have_content("#{pet_application1}")
      end
    end
  end
end
